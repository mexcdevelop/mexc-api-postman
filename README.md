...
MEXC now offers several Postman Collections and Environments (JSON files) for a quicker and easier usage of our RESTful APIs.<br/>
You only need to import and set up with your own API and secret keys to begin.

## How to import and configure
- Download the `mexc-api-postman` repository.
...
- `x-mexc-apikey` is not selected in your Postman `Headers` tab.
...
If you don't find your answer here, please consult https://t.me/MEXCAPIsupport for similar questions from the API support telegram group or open an issue [here](https://github.com/mxcdevelop/mexc-api-postman/issues).
